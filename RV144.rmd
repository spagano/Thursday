...
We would expect to see both graphs of eq size (50 % on each side) if the two are independant. They do not appear to be equal .. shedding doubt on the idea of independance.    
